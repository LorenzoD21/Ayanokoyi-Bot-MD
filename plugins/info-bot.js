...
conn.reply(m.chat, `🌠 ¡Hola! Soy Ayanokoyi Bot, en que puedo ayudarte hoy?\n\n✰ Usa *.menu* para ver mis comandos.`, m, rcanal, )
}
...
conn.reply(m.chat, `*Claro, El Bot Perzonalizado Simple Cuesta 7$ Con Server Incluído y comisión, trae comandos básicos.[🌠]*`, m, rcanal, )
}
...
if (/^ayanokoyi$/i.test(m.text)) {
conn.reply(m.chat, `*Hola Eres Fan De* *Brawl Stars*
*Entonces Sigue El Canal Oficial!*\n> https://whatsapp.com/channel/0029Vb9jL4r6rsQssSjulU3X*O Puedes Ir Al Sitio Web Oficial De CrowBot PP!*\n> *Gracias por utilizar AyanokoyiBot* `, m, rcanal, )
}
