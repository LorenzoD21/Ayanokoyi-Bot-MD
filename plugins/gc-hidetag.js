...
const handler = async (m, {conn, text, participants, isOwner, isAdmin}) => {
  try {
    ...
    const htextos = `${text ? text : '*_𝑯𝒐𝒍𝒂 𝑺𝒐𝒚 𝑨𝒚𝒂𝒏𝒐𝒌𝒐𝒚𝒊-𝑩𝑶𝑻 🫧_*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029Vb9jL4r6rsQssSjulU3X'}}}}}, {});
    }
  }
};
