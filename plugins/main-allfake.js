...
//CREADOR Y OTROS
global.creador = 'Wa.me/18493140441'
global.botreal = `${(conn.user.jid == global.conn.user.jid ? 'Oficial' : 'Sub-Bot')}`
global.ofcbot = `${conn.user.jid.split('@')[0]}`
global.asistencia = 'Wa.me/18493140441'
global.namech = '𝗔𝘆𝗮𝗻𝗼𝗸𝗼𝘆𝗶-𝗕𝗢𝗧-𝗠𝗗'
global.namechannel2 = 'ꨴ ☁꣺ꤪ꤬꤯ꨬꨶ ̷̸̲̼̈́ Mᴏᴏɴ Fᴏʀᴄᴇ Ƭᴇᴀᴍ 彡'
global.namegrupo = 'Group Ayanokoyi'
global.namecomu = 'Ayanokoyi community'
global.namecomu2 = 'Kiyotaka community'
...
global.canalNombreM = ["⏤͟͟͞͞ƙιყσƚαƙα  ⚡︎  αყαɳσƙσყι۵࿐", "ƙιყσƚαƙα - ɱԃ", "⏤͟͟͞͞☆ ᴬᵞᴬᴺᴼᴷᴼᵞᴵ - ᵀᴱˢᵀ"]
